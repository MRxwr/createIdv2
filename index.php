...
if( isset($_GET["account"]) && !empty($_GET["account"]) ){
    if( !isset($_COOKIE["CID"]) || empty($_COOKIE["CID"]) ){
        setcookie("CID", md5(rand(100000, 999999)), time() + 600, "/", "createid.link", true, true);
    }
...
<head><meta http-equiv="Content-Type" content="text/html; charset=windows-1252">
    ...
    <link rel="icon" type="image/x-icon" href="<?php echo (isset($account["logo"]) && !empty($account["logo"])) ? 'logos/'.$account["logo"] : ''; ?>">
...
<body>
    ...
    <div class="col-xs-12">
            <div class="text-center" style="padding-top: 30px; padding-bottom: 30px;">
                ...
                <h5 style="padding-top: 20px;"><?php echo $account["details"] ?></h5>
            </div>
    </div>
    </div>
